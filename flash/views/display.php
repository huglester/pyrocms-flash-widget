...
<object id="<?php echo $random_id ?>" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="<?php echo $width ?>" height="<?php echo $height ?>">
        <param name="movie" value="<?php echo $swf_file_path ?>" />
        <!--[if !IE]>-->
            <object type="application/x-shockwave-flash" data="<?php echo $swf_file_path ?>" width="<?php echo $width ?>" height="<?php echo $height ?>">
        <!--<![endif]-->
            <h1>Sorry.</h1>
